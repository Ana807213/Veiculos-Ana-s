...
<head>
    ...
    <title>Login - Veículos Ana's</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* --- NOVO: ESTILOS DO FORMULÁRIO DE LOGIN --- */
        .login-container {
            min-height: 60vh; /* Garante que o corpo tenha altura suficiente */
            display: flex;
            justify-content: center;
            align-items: center;
            padding: 50px 0;
            background-color: #f4f6f9; /* Fundo leve para destacar o cartão */
        }
        ...
        /* MOBILE E RESPONSIVIDADE (Ajustes para telas menores) */
...
<body>
    ...
    <header id="header-wrap" class="py-3">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="site-branding">
                <a class="logo-text" href="#">Veículos Ana's</a>
            </div>
            ...
            <div class="header-icon d-flex align-items-center">
                ...
                <a href="#" class="mx-3"><i class="fas fa-user"></i></a>
    ...
    <div class="login-container container">
        <div class="login-card">
            ...
            <form action="URL_PARA_O_DASHBOARD_ADMIN" method="POST">
                
                <div class="mb-3">
                    <label for="username" class="form-label"><i class="fas fa-user me-2"></i> Usuário ou E-mail</label>
                ...
                <div class="mt-3 text-center">
                    <a href="#" class="text-muted" style="color: var(--primary-color) !important;"></a>
                </div>
            </form>
        </div>
    </div>
